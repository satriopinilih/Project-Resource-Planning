  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
      <div>
        ...
        <p className="text-[var(--dash-text-muted)] text-sm mt-1 leading-relaxed">Overview of your current project landscape.</p>
      </div>
        ...
        <div className="flex items-center bg-[var(--dash-bg-card)] backdrop-blur-md p-1.5 rounded-2xl border border-[var(--dash-border-subtle)] shadow-sm transition-all hover:border-[var(--dash-border)]">
          <div className="flex items-center gap-3 px-4 py-2 border-r border-[var(--dash-border-subtle)]">
            ...
            <div className="flex flex-col">
              <span className="text-[9px] text-[var(--dash-text-faint)] uppercase font-black tracking-widest leading-none mb-1">Local</span>
          ...
          <div className="flex items-center gap-3 px-4 py-2">
            ...
            <div className="flex flex-col">
              <span className="text-[9px] text-[var(--dash-text-faint)] uppercase font-black tracking-widest leading-none mb-1">Calendar</span>
              <span className="text-sm font-bold text-[var(--dash-text-primary)]">{formatDate(time)}</span>
            </div>
          </div>
        </div>
      </div>
