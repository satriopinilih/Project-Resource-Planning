  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-64 flex-col bg-white dark:bg-[var(--dash-bg-sidebar)] border-r border-gray-200 dark:border-[var(--dash-border)] transition-colors duration-300">
      ...
      <div className="px-8 pt-8 pb-6">
        <h1 className="text-[20px] font-bold text-gray-900 dark:text-[var(--dash-text-heading)] leading-tight tracking-tight">
          Resource Planning
        </h1>
        <p className="text-[14px] text-gray-500 dark:text-[var(--dash-text-muted)] mt-1 font-medium">
          Consulting System
        </p>
      </div>
