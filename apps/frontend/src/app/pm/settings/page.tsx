...
export default function SettingsPage() {
    ...
    return (
        <div className="p-8 w-full space-y-8 pb-16 h-full overflow-y-auto">
            {/* Profile Information */}
            <div className="bg-white dark:bg-[#292B2F] rounded-2xl shadow-sm dark:border-gray-700 px-10 py-8 mb-6">
                ...
                <div className="flex items-start gap-8">
                    {/* Avatar */}
                    <div className="w-20 h-20 rounded-full bg-[#0ea5e9] flex items-center justify-center text-white flex-shrink-0 mt-1 shadow-md">
                    ...
                    <div className="flex-1 grid grid-cols-2 gap-x-8 gap-y-6">
                        <div>
                            ...
                            <div className="px-4 py-3 bg-gray-50 dark:bg-[#1e2532] text-[14px] text-gray-900 dark:text-gray-100 rounded-lg border border-gray-100 dark:border-gray-800">
                                {profile?.userName || "Project Manager"}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="px-4 py-3 bg-gray-50 dark:bg-[#1e2532] text-[14px] text-gray-900 dark:text-gray-100 rounded-lg border border-gray-100 dark:border-gray-800">
                                {profile?.userId || "PM001"}
                            </div>
                        </div>

                        <div className="col-span-2">
                            <div className="text-[13px] font-medium text-gray-500 dark:text-gray-400 mb-2">Role</div>
                            <div className="inline-flex items-center justify-center px-4 py-2 bg-sky-100 dark:bg-[#1e3a5f] text-sky-700 dark:text-[#60a5fa] text-[13px] font-bold rounded-lg border border-sky-200 dark:border-sky-800/50">
                                {profile?.roles?.[0] || "PM"}
                            </div>
                        </div>
                    </div>
            ...
            {/* Appearance */}
            <div className="bg-white dark:bg-[#292B2F] rounded-2xl shadow-sm  dark:border-gray-700/50 p-8 mb-6">
                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-6 py-3 bg-gray-100 dark:bg-[#2c3444] hover:bg-gray-200 dark:hover:bg-[#343d4f] text-gray-700 dark:text-gray-200 rounded-lg transition-colors text-[13px] font-semibold border border-gray-200 dark:border-gray-700"
                    >
                        {isDarkMode ? (
                            <>
            ...
            <div className="bg-white dark:bg-[#292B2F] rounded-2xl shadow-sm  dark:border-gray-700/50 p-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="px-4 py-3 bg-gray-50 dark:bg-[#1e2532] rounded-lg border border-gray-100 dark:border-gray-800">
                        <div className="text-[13px] font-medium text-gray-500 dark:text-gray-400 mb-1">Version</div>
                        <div className="text-[14px] text-gray-900 dark:text-gray-100 font-bold">1.0.0</div>
                    </div>

                    <div className="px-4 py-3 bg-gray-50 dark:bg-[#1e2532] rounded-lg border border-gray-100 dark:border-gray-800">
                        <div className="text-[13px] font-medium text-gray-500 dark:text-gray-400 mb-1">Environment</div>
                        <div className="text-[14px] text-gray-900 dark:text-gray-100 font-bold">Production</div>
                    </div>

                    <div className="px-4 py-3 bg-gray-50 dark:bg-[#1e2532] rounded-lg border border-gray-100 dark:border-gray-800">
                        <div className="text-[13px] font-medium text-gray-500 dark:text-gray-400 mb-1">Current Year</div>
                        <div className="text-[14px] text-gray-900 dark:text-gray-100 font-bold">2026</div>
                    </div>

                    <div className="px-4 py-3 bg-gray-50 dark:bg-[#1e2532] rounded-lg border border-gray-100 dark:border-gray-800">
                        <div className="text-[13px] font-medium text-gray-500 dark:text-gray-400 mb-1">Storage</div>
                        <div className="text-[14px] text-gray-900 dark:text-gray-100 font-bold">Local Browser</div>
                    </div>
                </div>
            </div>
        </div >
