      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-8">
            ...
            <div className="flex items-start gap-8">
              ...
              <div className="flex-1 grid grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="text-gray-900 dark:text-white">HR Manager</div>
                </div>
                
                <div>
                  <div className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">User ID</div>
                  <div className="text-gray-900 dark:text-white">HR123</div>
                </div>
          ...
          <div className="bg-white dark:bg-[#292B2F] rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8 mb-6">
            ...
            <div className="mb-6">
              <div className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Theme</div>
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-6">
              <div className="text-sm font-medium text-[#2B7FFC] mb-4">Current Theme Colors:</div>
              <div className="grid grid-cols-4 gap-4">
                <div>
                  <div className={`h-16 border-2 rounded-lg mb-2 ${
                    isDarkMode 
                      ? 'bg-[#202020] border-gray-700' 
                      : 'bg-[#E9EEF6] border-gray-200'
                  }`}></div>
                  <div className="text-xs text-gray-600 dark:text-gray-400 text-center">Background</div>
                </div>
                <div>
                  <div className={`h-16 border-2 rounded-lg mb-2 ${
                    isDarkMode 
                  ...
                  <div className="text-xs text-gray-600 dark:text-gray-400 text-center">Card</div>
                </div>
                <div>
                  <div className={`h-16 border-2 rounded-lg mb-2 ${
                    isDarkMode 
                  ...
                  <div className="text-xs text-gray-600 dark:text-gray-400 text-center">Sidebar</div>
                </div>
                <div>
                  <div className="h-16 border-2 rounded-lg mb-2 bg-[#2B7FFC] border-[#2B7FFC]"></div>
                  <div className="text-xs text-gray-600 dark:text-gray-400 text-center">Primary</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-[#292B2F] rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8 mb-6">
            ...
            <div className="flex items-start gap-4 p-4 bg-blue-50 dark:bg-[#2B7FFC]/10 border border-blue-200 dark:border-[#2B7FFC]/30 rounded-lg mb-6">
              <div className="p-2 bg-blue-100 dark:bg-[#2B7FFC]/20 rounded-lg">
                <svg className="w-6 h-6 text-[#2B7FFC]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4" />
                </svg>
              </div>
              <div>
                <div className="font-medium text-gray-900 dark:text-white">Local Storage</div>
                <div className="text-sm text-gray-600 dark:text-gray-400 mt-1">All data is saved in your browser</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between py-4 border-b border-gray-200 dark:border-gray-700">
              <div>
                <div className="font-medium text-gray-900 dark:text-white">Reset to Demo Data</div>
                <div className="text-sm text-gray-600 dark:text-gray-400 mt-1">Restore the default demo projects and assignments</div>
              </div>
            ...
            <div className="flex items-center justify-between py-4">
              <div>
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400 mt-1">Remove all projects and assignments from storage</div>
              </div>
          ...
          <div className="bg-white dark:bg-[#292B2F] rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                <div className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Version</div>
                <div className="text-gray-900 dark:text-white">1.0.0</div>
              </div>

              <div>
                <div className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Environment</div>
                <div className="text-gray-900 dark:text-white">Production</div>
              </div>

              <div>
                <div className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Current Year</div>
              ...
              <div>
                ...
                <div className="text-gray-900 dark:text-white">Local Browser</div>
              </div>
            </div>
          </div>
        </main>
